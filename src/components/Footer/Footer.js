    ...
    render() {
        return (
            ...
            <footer>
                ...
                <aside className="o-uao-footer-logo-left">
                    <div className="o-uao-footer-logos-1"></div>
                    <div className="o-uao-footer-divisor"></div>
                    <div className="o-uao-footer-logos-2"></div>
                </aside>

                <aside className="o-uao-footer-options-right">
                    <nav className = "o-uao-links">
                        <a className="o-uao-link-1" href="https://uaovirtual.edu.co/" target>
                            <p>¿Qué es?</p>
                        </a>
